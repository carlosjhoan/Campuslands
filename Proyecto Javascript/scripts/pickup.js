        ...
        function ok_my_order () {
            ...
            if (arr_divs_id.length >0) {
                ...
                review_table = `<b>N° Factura:</b> ${id_order}<br>
                         ...
                         <b>Hora recoger:</b> ${document.getElementById("range_time").value}<br>
                ...
                review_table += `<b>Precio:</b> $${moneyFormatter.format(total_price)} COP<br><b>Direcc recoger:</b> <em>Cra 1BE #29-48 La Cumbre</em><br><b>Fecha:</b> ${now.toLocaleString()}<br>`
                ...
                data = {
                    ...
                    "hora" : `${document.getElementById("range_time").value}`,
